...
class BlurViewModel(application: Application) : ViewModel() {
    ...
    internal fun applyBlur(blurLevel: Int) {
        ...
        val saveFileWorkRequest = OneTimeWorkRequest.Builder(SaveImageToFileWorker::class.java).setConstraints(constraints).addTag(
            TAG_OUTPUT).build()
        continuation = continuation.then(saveFileWorkRequest)
